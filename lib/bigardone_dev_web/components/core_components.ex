defmodule BigardoneDevWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(BigardoneDevWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(BigardoneDevWeb.Gettext, "errors", msg, opts)
    # end
